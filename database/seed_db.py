...
def seed_test_data():
    with app.app_context():
        ...
        Rule(discipline_id=disciplines[1].id, rule_name="Schlagballwurf/Wurfball, 6-7", unit="m,cm",
        ...
        Rule(discipline_id=disciplines[1].id, rule_name="Schlagballwurf/Wurfball, 8-9", unit="m,cm",
        description_m="Schlagballwurf (80 g)", description_f="Schlagballwurf (80 g)",
        min_age=8, max_age=9,
        ...
        Rule(discipline_id=disciplines[1].id, rule_name="Schlagballwurf/Wurfball, 10-11", unit="m,cm",
        description_m="Schlagballwurf (80 g)", description_f="Schlagballwurf (80 g)",
        min_age=10, max_age=11,
        ...
        Rule(discipline_id=disciplines[1].id, rule_name="Schlagballwurf/Wurfball, 12-13", unit="m,cm",
        description_m="Schlagballwurf (80 g)", description_f="Schlagballwurf (80 g)",
        min_age=12, max_age=13,
        ...
        Rule(discipline_id=disciplines[1].id, rule_name="Schlagballwurf/Wurfball, 14-15", unit="m,cm",
        description_m="Schlagballwurf (80 g)", description_f="Schlagballwurf (80 g)",
        min_age=14, max_age=15,
        ...
        Rule(discipline_id=disciplines[1].id, rule_name="Schlagballwurf/Wurfball, 16-17", unit="m,cm",
        description_m="Schlagballwurf (80 g)", description_f="Schlagballwurf (80 g)",
        min_age=16, max_age=17,
