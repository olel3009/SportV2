...
def seed_test_data():
    with app.app_context():
        ...
        athletes = [
        Athlete(first_name="Lena", last_name="Müller", birth_date=parse_date("1.1.2010"), gender="f", swim_certificate=False),
        Athlete(first_name="Tom", last_name="Schmidt", birth_date=parse_date("1.1.2009"), gender="m", swim_certificate=False),
        Athlete(first_name="Alex", last_name="Klein", birth_date=parse_date("1.1.2011"), gender="m", swim_certificate=False),
        Athlete(first_name="Sophie", last_name="Bauer", birth_date=parse_date("1.1.2008"), gender="f", swim_certificate=True),
        Athlete(first_name="Jonas", last_name="Meier", birth_date=parse_date("1.1.2010"), gender="m", swim_certificate=False),
        Athlete(first_name="Marie", last_name="Schulz", birth_date=parse_date("1.1.2012"), gender="f", swim_certificate=False),
        Athlete(first_name="Lukas", last_name="Becker", birth_date=parse_date("1.1.2011"), gender="m", swim_certificate=False),
        Athlete(first_name="Emily", last_name="Fischer", birth_date=parse_date("1.1.2010"), gender="f", swim_certificate=True),
        Athlete(first_name="Paul", last_name="Hoffmann", birth_date=parse_date("1.1.2008"), gender="m", swim_certificate=True),
        Athlete(first_name="Lara", last_name="Wagner", birth_date=parse_date("1.1.2011"), gender="f", swim_certificate=True),
        Athlete(first_name="Tim", last_name="Neumann", birth_date=parse_date("1.1.2008"), gender="m", swim_certificate=False),
        Athlete(first_name="Anna", last_name="Hartmann", birth_date=parse_date("1.1.2009"), gender="f", swim_certificate=True),
        Athlete(first_name="Leon", last_name="Zimmermann", birth_date=parse_date("1.1.2010"), gender="m", swim_certificate=False),
        Athlete(first_name="Nina", last_name="Krüger", birth_date=parse_date("1.1.2011"), gender="f", swim_certificate=False),
        Athlete(first_name="Max", last_name="Wolf", birth_date=parse_date("1.1.2009"), gender="m", swim_certificate=False),
        Athlete(first_name="Lilly", last_name="Schneider", birth_date=parse_date("1.1.2012"), gender="f", swim_certificate=False),
        Athlete(first_name="Ben", last_name="Richter", birth_date=parse_date("1.1.2008"), gender="m", swim_certificate=False),
        Athlete(first_name="Emma", last_name="Koch", birth_date=parse_date("1.1.2010"), gender="f", swim_certificate=True),
        Athlete(first_name="Noah", last_name="Klein", birth_date=parse_date("1.1.2008"), gender="m", swim_certificate=True),
        Athlete(first_name="Clara", last_name="Werner", birth_date=parse_date("1.1.2011"), gender="f", swim_certificate=True),
        Athlete(first_name="Luis", last_name="Schäfer", birth_date=parse_date("1.1.2009"), gender="m", swim_certificate=False),
    ]
