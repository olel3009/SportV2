...
def seed_test_data():
    with app.app_context():
        ...
        trainers = [
        Trainer(first_name="Ole", last_name="Leister", email="ole.leister@trainer.de" , birth_date=date(1,1,2003), gender="m"),
        Trainer(first_name="Carlo", last_name="Bockermann", email="carlo.bockermann@trainer.de" , birth_date=date(1,1,2003), gender="m"),
    ]
        # Erstelle mehrere Athleten
        athletes = [
        Athlete(first_name="Lena", last_name="Müller", birth_date=date(1,1,2010), gender="f", swim_certificate=False),
        Athlete(first_name="Tom", last_name="Schmidt", birth_date=date(1,1,2009), gender="m", swim_certificate=False),
        Athlete(first_name="Alex", last_name="Klein", birth_date=date(1,1,2011), gender="m", swim_certificate=False),
        Athlete(first_name="Sophie", last_name="Bauer", birth_date=date(1,1,2008), gender="f", swim_certificate=True),
        Athlete(first_name="Jonas", last_name="Meier", birth_date=date(1,1,2010), gender="m", swim_certificate=False),
        Athlete(first_name="Marie", last_name="Schulz", birth_date=date(1,1,2012), gender="f", swim_certificate=False),
        Athlete(first_name="Lukas", last_name="Becker", birth_date=date(1,1,2011), gender="m", swim_certificate=False),
        Athlete(first_name="Emily", last_name="Fischer", birth_date=date(1,1,2010), gender="f", swim_certificate=True),
        Athlete(first_name="Paul", last_name="Hoffmann", birth_date=date(1,1,2008), gender="m", swim_certificate=True),
        Athlete(first_name="Lara", last_name="Wagner", birth_date=date(1,1,2011), gender="f", swim_certificate=True),
        Athlete(first_name="Tim", last_name="Neumann", birth_date=date(1,1,2008), gender="m", swim_certificate=False),
        Athlete(first_name="Anna", last_name="Hartmann", birth_date=date(1,1,2009), gender="f", swim_certificate=True),
        Athlete(first_name="Leon", last_name="Zimmermann", birth_date=date(1,1,2010), gender="m", swim_certificate=False),
        Athlete(first_name="Nina", last_name="Krüger", birth_date=date(1,1,2011), gender="f", swim_certificate=False),
        Athlete(first_name="Max", last_name="Wolf", birth_date=date(1,1,2009), gender="m", swim_certificate=False),
        Athlete(first_name="Lilly", last_name="Schneider", birth_date=date(1,1,2012), gender="f", swim_certificate=False),
        Athlete(first_name="Ben", last_name="Richter", birth_date=date(1,1,2008), gender="m", swim_certificate=False),
        Athlete(first_name="Emma", last_name="Koch", birth_date=date(1,1,2010), gender="f", swim_certificate=True),
        Athlete(first_name="Noah", last_name="Klein", birth_date=date(1,1,2008), gender="m", swim_certificate=True),
        Athlete(first_name="Clara", last_name="Werner", birth_date=date(1,1,2011), gender="f", swim_certificate=True),
        Athlete(first_name="Luis", last_name="Schäfer", birth_date=date(1,1,2009), gender="m", swim_certificate=False),
    ]
        ...
        rules = [
        Rule(discipline_id=disciplines[0].id, rule_name="800m Lauf, 6-7", unit="Zeit (Min.,Sek.)",
        ...
        valid_start=date(1,1,2025), valid_end=date(31,12,2025), version = 1
    ),
        Rule(discipline_id=disciplines[0].id, rule_name="800m Lauf, 8-9", unit="Zeit (Min.,Sek.)",
        description_m="800m Lauf", description_f="800m Lauf",
        min_age=8, max_age=9,
        ...
        Rule(discipline_id=disciplines[0].id, rule_name="800m Lauf, 10-11", unit="Zeit (Min.,Sek.)",
        description_m="800m Lauf", description_f="800m Lauf",
        ...
        Rule(discipline_id=disciplines[0].id, rule_name="800m Lauf, 12-13", unit="Zeit (Min.,Sek.)",
        description_m="800m Lauf", description_f="800m Lauf",
        ...
        Rule(discipline_id=disciplines[0].id, rule_name="800m Lauf, 14-15", unit="Zeit (Min.,Sek.)",
        description_m="800m Lauf", description_f="800m Lauf",
        ...
        Rule(discipline_id=disciplines[0].id, rule_name="800m Lauf, 16-17", unit="Zeit (Min.,Sek.)",
        description_m="800m Lauf", description_f="800m Lauf",
        ...
        Rule(discipline_id=disciplines[1].id, rule_name="Schlagballwurf, 6-7", unit="Distanz (m,cm)",
        ...
        Rule(discipline_id=disciplines[1].id, rule_name="Schlagballwurf, 8-9", unit="Distanz (m,cm)",
        description_m="Schlagballwurf (80 g)", description_f="Schlagballwurf (80 g)",
        min_age=8, max_age=9,
        ...
        Rule(discipline_id=disciplines[1].id, rule_name="Schlagballwurf, 10-11", unit="Distanz (m,cm)",
        description_m="Schlagballwurf (80 g)", description_f="Schlagballwurf (80 g)",
        min_age=10, max_age=11,
        ...
        Rule(discipline_id=disciplines[1].id, rule_name="Schlagballwurf, 12-13", unit="Distanz (m,cm)",
        description_m="Schlagballwurf (80 g)", description_f="Schlagballwurf (80 g)",
        min_age=12, max_age=13,
        ...
        Rule(discipline_id=disciplines[1].id, rule_name="Schlagballwurf, 14-15", unit="Distanz (m,cm)",
        description_m="Schlagballwurf (80 g)", description_f="Schlagballwurf (80 g)",
        min_age=14, max_age=15,
        ...
        Rule(discipline_id=disciplines[1].id, rule_name="Schlagballwurf, 16-17", unit="Distanz (m,cm)",
        description_m="Schlagballwurf (80 g)", description_f="Schlagballwurf (80 g)",
        min_age=16, max_age=17,
        ...
        Rule(discipline_id=disciplines[2].id, rule_name="25 m Schwimmen, 6-7", unit="Zeit (Sek.,1/10 Sek.)",
        ...
        Rule(discipline_id=disciplines[2].id, rule_name="25 m Schwimmen, 8-9", unit="Zeit (Sek.,1/10 Sek.)",
        description_m="25 m Schwimmen", description_f="25 m Schwimmen",
        min_age=8, max_age=9,
        ...
        Rule(discipline_id=disciplines[2].id, rule_name="25 m Schwimmen, 10-11", unit="Zeit (Sek.,1/10 Sek.)",
        description_m="25 m Schwimmen", description_f="25 m Schwimmen",
        min_age=10, max_age=11,
        ...
        Rule(discipline_id=disciplines[2].id, rule_name="25 m Schwimmen, 12-13", unit="Zeit (Sek.,1/10 Sek.)",
        description_m="25 m Schwimmen", description_f="25 m Schwimmen",
        min_age=12, max_age=13,
        ...
        Rule(discipline_id=disciplines[2].id, rule_name="25 m Schwimmen, 14-15", unit="Zeit (Sek.,1/10 Sek.)",
        description_m="25 m Schwimmen", description_f="25 m Schwimmen",
        min_age=14, max_age=15,
        ...
        Rule(discipline_id=disciplines[2].id, rule_name="25 m Schwimmen, 16-17", unit="Zeit (Sek.,1/10 Sek.)",
        description_m="25 m Schwimmen", description_f="25 m Schwimmen",
        min_age=16, max_age=17,
        ...
        Rule(discipline_id=disciplines[3].id, rule_name="Hochsprung, 6-7", unit="Distanz (m,cm)",
        ...
        Rule(discipline_id=disciplines[3].id, rule_name="Hochsprung, 8-9", unit="Distanz (m,cm)",
        description_m="Hochsprung", description_f="Hochsprung",
        min_age=8, max_age=9,
        ...
        Rule(discipline_id=disciplines[3].id, rule_name="Hochsprung, 10-11", unit="Distanz (m,cm)",
        description_m="Hochsprung", description_f="Hochsprung",
        min_age=10, max_age=11,
        ...
        Rule(discipline_id=disciplines[3].id, rule_name="Hochsprung, 12-13", unit="Distanz (m,cm)",
        description_m="Hochsprung", description_f="Hochsprung",
        min_age=12, max_age=13,
        ...
        Rule(discipline_id=disciplines[3].id, rule_name="Hochsprung, 14-15", unit="Distanz (m,cm)",
        description_m="Hochsprung", description_f="Hochsprung",
        min_age=14, max_age=15,
        ...
        Rule(discipline_id=disciplines[3].id, rule_name="Hochsprung, 16-17", unit="Distanz (m,cm)",
        description_m="Hochsprung", description_f="Hochsprung",
        min_age=16, max_age=17,
