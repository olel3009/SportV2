...
def get_trainer_id(id):
    ...
    schema = TrainerSchema()
    logging.info("Trainer erfolgreich aufgerufen!")
...
def update_trainer(id):
    ...
    db.session.commit()
    logging.info("Trainer erfolgreich aktualisiert!")
...
def delete_trainer(id):
    ...
    db.session.commit()
    logging.info("Trainer erfolgreich gelöscht!")
