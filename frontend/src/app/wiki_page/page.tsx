    ...
    <div className={styles.container}>
      <nav className={styles.sidebar}>
        <ul>
          ...
          <li><a id="link_erstellen_ändern_von_reglungen" href="#erstellen_ändern_von_reglungen">Erstellen oder Ändern von Reglungen</a></li>
      ...
      <div className={styles.content}>
        ...
        <div id="erstellen_ändern_von_reglungen" className={styles.section}>
